...
Public Sub Initialize (vCallback As Object, vEventName As String)
	...
	sv.Panel.Color = Colors.RGB(232, 232, 232)
	sv.Color = Colors.RGB(232, 232, 232)
End Sub
...
Public Sub InsertAt(Index As Int, Pnl As Panel, ItemHeight As Int, Value As Object)
	...
	Else
		...
		sv.Panel.AddView(p, 0, top, sv.Width, ItemHeight)
	End If
	sv.Panel.Height = sv.Panel.Height + ItemHeight + dividerHeight + bet
...
Public Sub getPanelHeight As Int
 Return sv.Panel.Height
End Sub

Public Sub setPH(Value As Int)
sv.Panel.Height = Value
End Sub
...
Public Sub increasePanel
sv.Panel.Height = sv.Panel.Height + 30dip
