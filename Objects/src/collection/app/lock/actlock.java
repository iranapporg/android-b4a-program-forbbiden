...
public class actlock extends Activity implements B4AActivity{
	public static actlock mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "collection.app.lock", "collection.app.lock.actlock");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actlock).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "collection.app.lock", "collection.app.lock.actlock");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "collection.app.lock.actlock", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actlock) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actlock) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actlock) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 15;BA.debugLine="Activity.LoadLayout(\"frmlock\")";
mostCurrent._activity.LoadLayout("frmlock",mostCurrent.activityBA);
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 31;BA.debugLine="Sub btnback_Click";
