...
public class actsplash extends Activity implements B4AActivity{
	public static actsplash mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "collection.app.lock", "collection.app.lock.actsplash");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (actsplash).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "collection.app.lock", "collection.app.lock.actsplash");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "collection.app.lock.actsplash", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (actsplash) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (actsplash) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (actsplash) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public anywheresoftware.b4a.objects.ImageViewWrapper _imgbg = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 17;BA.debugLine="Activity.LoadLayout(\"frmsplash\")";
mostCurrent._activity.LoadLayout("frmsplash",mostCurrent.activityBA);
 //BA.debugLineNum = 19;BA.debugLine="If pre.GetBoolean(\"service\") = True Then";
if (mostCurrent._pre.GetBoolean("service")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 20;BA.debugLine="StartService(force_close)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._force_close.getObject()));
 };
 //BA.debugLineNum = 23;BA.debugLine="tim.Initialize(\"timer\",1300)";
_tim.Initialize(processBA,"timer",(long) (1300));
 //BA.debugLineNum = 24;BA.debugLine="tim.Enabled = True";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Private imgbg As ImageView";
mostCurrent._imgbg = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 12;BA.debugLine="Private lbl1 As Label";
mostCurrent._lbl1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 13;BA.debugLine="Dim pre As PreferenceManager";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 7;BA.debugLine="Private tim As Timer";
...
public static String  _timer_tick() throws Exception{
 ...
 //BA.debugLineNum = 36;BA.debugLine="tim.Enabled = False";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 43;BA.debugLine="ProgressDialogShow2(\"منتظر بمانید\",False)";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,"منتظر بمانید",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 44;BA.debugLine="StartActivity(actList)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._actlist.getObject()));
